    ...
    return (
        <Grid item container direction="column">
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer} alignItems="center" style={{ marginTop: "5em" }}>
                <Grid item lg>
                    <img src={vision} alt="The Vision" style={{ maxWidth: matchesSM ? 300 : "40em", marginRight: matchesMD ? 0 : "5em", marginBottom: matchesMD ? "5em" : 0 }} />
                </Grid>
                <Grid item container direction="column" lg style={{ textAlign: matchesMD ? "center" : "right", maxWidth: "40em" }}>
                    <Grid item>
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer} alignItems="center" style={{ marginTop: "5em" }}>
                ...
                <Grid item container direction="column" lg style={{ textAlign: matchesMD ? "center" : "inherit", maxWidth: "40em" }}>
                    <Grid item>
                        <Typography variant="h4" gutterBottom>
                            Technology
                        </Typography>
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer} style={{ backgroundColor: "#B3B3B3", height: "90em" }}>
                <Grid item container direction="column" lg style={{ textAlign: matchesMD ? "center" : "inherit" }} alignItems={matchesMD ? "center" : undefined}>
                    <Grid item>
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src={consultation} alt="hand shake" width="100%" style={{ maxWidth: 1000 }} />
                </Grid>
            </Grid>
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer} style={{ backgroundColor: "#FF7373", height: "90em" }}>
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img width="100%"
                        src={mockup} alt="basic website design outline" style={{ maxWidth: 1000 }} />
                </Grid>
            </Grid>
            {/*Review*/}
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer} style={{ backgroundColor: "#39B54A", height: "90em" }}>
                <Grid item container direction="column" lg style={{ textAlign: matchesMD ? "center" : "inherit" }} alignItems={matchesMD ? "center" : undefined}>
                    ...
                    <Grid item>
                        <Typography variant="body1" align="center" paragraph style={{ color: "#fff", maxWidth: "20em" }}>
                            Before moving any farther we come back to you with our progress. This gives you the freedom to discuss any changes you may want or any ideas you may have come up with before any heavy lifting has been done.                        </Typography>

                        <Typography variant="body1" paragraph style={{ color: "#fff", maxWidth: "20em" }}>
                            We give you an interactive demonstration of the mockups, thoroughly explaining the thought process that went into each screen and every anticipated feature.                        </Typography>

                        <Typography variant="body1" paragraph style={{ color: "#fff", maxWidth: "20em" }}>
                            Once you’re completely satisfied with the vision for our solution we get down to the nitty gritty, fine-details of design.                        </Typography>
                    </Grid>
                </Grid>

                <Grid item lg style={{ alignSelf: "center" }}>
                    <img width="100%"
                        src={review} alt="basic website design outline"
                        style={{ maxWidth: 1000 }}
                    />
                </Grid>
            </Grid>
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer} style={{ backgroundColor: "#39B54A", height: "90em" }}>
                <Grid item container direction="column" lg style={{ textAlign: matchesMD ? "center" : "inherit" }} alignItems={matchesMD ? "center" : undefined}>
                    <Grid item>
                        <Typography variant="h4" align="center" gutterBottom style={{ color: "#000", marginTop: "5em" }}>
                            Review
                        </Typography>
                    </Grid>
                    <Grid item>
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer} style={{ backgroundColor: "#C1272D", height: "90em" }}>
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src={launch}
                        alt="rocket"
                        style={{ maxWidth: 200, maxHeight: matchesSM ? 600 : undefined }}
                        width="100%" />
                </Grid>
            </Grid>
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer} style={{ backgroundColor: "#29ABE2", height: "90em" }}>
                <Grid item container direction="column" lg style={{ textAlign: matchesMD ? "center" : "inherit" }}>
                    <Grid item>
                        <Typography variant="h4" gutterBottom style={{ color: "#000", marginTop: "5em" }}>
                            Iterate
                        </Typography>
